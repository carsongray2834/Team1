...
a.out: main.o particleSystem.o linkedlist.o particle.o graphics.o Node.h carson.h jackson.h gurshan.h
	$(CXX) $(CXXFLAGS) -g main.o linkedlist.o particleSystem.o particle.o graphics.o
main.o: main.cc particleSystem.o carson.h jackson.h gurshan.h
